...
public class HotProductsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hot_products, container, false);
        ...
        // 设置 ViewPager2
        ViewPager2 viewPager = view.findViewById(R.id.viewPager1);
        ProductPagerAdapter1 adapter = new ProductPagerAdapter1(productList);
